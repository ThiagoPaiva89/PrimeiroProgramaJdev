...
public class Aluno {
	...
	public String getResultadoAluno() { /*Situação do aluno, está ou não aprovado*/
		double media = this.getMediaNota();
		if(media >= 50) {
			if(media >= 70) {
	...
	public Aluno() { /*Método construtor - Cria os dados na memóiria do java*/
